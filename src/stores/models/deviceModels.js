...
export const GooglePixelModels = {
  "Pixel 8 Series": [
...
export const GooglePixelStorage = [
  { value: "128GB", label: "128GB" },
  { value: "256GB", label: "256GB" },
  { value: "512GB", label: "512GB" },
];

export const GooglePixelColors = [
...
export const AppleComputerModels = [
...
export const DellComputerModels = [
...
export const LenovoComputerModels = [
...
export const AsusComputerModels = [
...
export const MicrosoftComputerModels = [
...
export const AcerComputerModels = [
...
// MSI Computer Models
export const MSIComputerModels = [
...
export const SamsungComputerModels = [
...
export const computerProcessors = [
...
export const computerGraphicsCards = [
